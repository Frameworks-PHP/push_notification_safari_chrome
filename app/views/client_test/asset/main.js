...
//    link.rel  = 'stylesheet';
//    link.href = 'http://localhost:9090/admin/OneSignalSDKStyles.css';
...
function updateSubscriptionOnServer(subscription) {
  ...
  //   document.querySelector('.js-subscription-details');
    ...
    if (subscription) {
        ...
        fetch('https://webpush.mobo.vn/api/saveSubscription', {
            crossOrigin: true,
            method: 'post',
            headers: { 
             accept: '*/*',                
        ...
        fetch('https://webpush.mobo.vn/api/unSaveSubscription', {
            crossOrigin: true,
            method: 'post',
            headers: {
                accept: '*/*',                
    ...
    if (Notification.permission !== 'denied' || Notification.permission === "default") {
        Notification.requestPermission(function () {
            ...
            navigator.serviceWorker.ready.then(function(registration) {
                ...
                return fetch('https://webpush.mobo.vn/api/register', {
                            crossOrigin: true,
                            method: 'post',
                            headers: {
                                accept: '*/*',
    ...
    getSubscription().then(function(subscription) {
        return subscription.unsubscribe()
            .then(function() {
                var data = JSON.parse(JSON.stringify(subscription));
                data.site = location.host;
                return fetch('https://webpush.mobo.vn/api/unregister', {
                    crossOrigin: true,
                    method: 'post',
                    headers: {
                        accept: '*/*',
