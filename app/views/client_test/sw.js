...
self.addEventListener('push', function(event) {
  ...
  var notificationOptions = event.data ? JSON.parse(event.data.text()) : {
        title: 'ME IT',
        body: 'MECORP : Author : Phunld',
        icon: 'https://www.mecorp.vn/assets/templates/mecorp/master/nzMgQR/images/logo.png',
        image: 'https://www.mecorp.vn/assets/templates/mecorp/master/nzMgQR/images/logo.png',
        data:{
            url: 'https://mecorp.vn/',
        },
      };
...
//  };
    ...
    url.push(notificationOptions.url);  
