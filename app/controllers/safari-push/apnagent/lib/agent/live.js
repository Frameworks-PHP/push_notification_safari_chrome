...
Agent.prototype._queueIterator = function (obj, next) {
  ...
  //obj.json.payload = JSON.parse('{"aps":{"alert":{"title":"testdata","body":"body","action":"click"},"url-args":["clicked"]}}');
  //obj.json.payload = JSON.parse('{"aps":{"alert":"Testing.. (4)","badge":1,"sound":"default"}}');
  //console.log(this);
  //cast data args to array 
  obj.json.payload.aps = util.castArgs(obj.json.payload.aps);
  //console.log(obj.json.payload);
